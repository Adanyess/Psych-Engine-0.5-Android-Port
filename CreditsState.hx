...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Corruption Team'],
			['Gladiator',		    'gladiator',		    'Sprite Maker',	 ' https://youtube.com/channel/UCm0PJNh7FyNNGMgwQUC7ayw',	    'F73838'],
			['Adanyes',		        'adanyes',		    'Coding',	                 ' https://youtube.com/channel/UCqOj6gsglWOek-7Jx5oGMpQ',	    '261EA9'],						
			[''],
			['Psych Engine Team'],
